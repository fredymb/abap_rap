CLASS zcl_aux_travel_det_fmb DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  TYPES: tt_travel_reported TYPE TABLE FOR REPORTED z_i_travel_fmb ,
         tt_booking_reported TYPE TABLE FOR REPORTED z_i_booking_fmb,
         tt_supplements_reported TYPE TABLE FOR REPORTED z_i_booksuppl_fmb.
