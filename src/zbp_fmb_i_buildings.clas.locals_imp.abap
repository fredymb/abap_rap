CLASS lsc_zfmb_i_buildings DEFINITION INHERITING FROM cl_abap_behavior_saver.
...
CLASS lsc_zfmb_i_buildings IMPLEMENTATION.
...
*    reading the building entites
    READ ENTITIES OF zfmb_i_buildings IN LOCAL MODE
        ENTITY Building
        ALL FIELDS
