...
CLASS lhc_Supplement IMPLEMENTATION.
  ...
  METHOD calculateTotalSupplPrice.
    ...
    IF NOT keys IS INITIAL.
      zcl_aux_travel_det_fmb=>calculate_price( it_travel_id = VALUE #( FOR GROUPS
      <booking_suppl> OF booking_key IN keys
...
DATA: lt_supplements TYPE STANDARD TABLE OF zbooksuppl_fmb,
